...
redact-secret 0.1.0-beta.9 loaded addon
API_KEY=<SECRET_1>
findings: 1
```
...
python3 -m venv .venv
.venv/bin/python -m pip install --only-binary=:all: redact-secret==0.1.0b9
```
...
npm init -y
npm pkg set type=module
npm install @redact-secret/core@0.1.0-beta.9 vite@7.3.6
```
...
redact-secret 0.1.0-beta.9 loaded wasm
API_KEY=<SECRET_1>
findings: 1
```
