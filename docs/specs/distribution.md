...
| The generated support matrix is projected into `docs/support-matrix.md` and release notes as a pinned copy, not hand-maintained separately. | [Project the generated support matrix into docs and release notes via a pinned copy](../decisions/2026-09-21-project-the-support-matrix-into-docs-and-release-notes.md) |
