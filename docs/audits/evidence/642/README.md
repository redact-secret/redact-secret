...
## Update 2026-09-23: qualification

The "Done when" above is met in candidate mode. The benchmark contracts,
twins and ledger rows landed in redact-secret-benchmarks#112, and one pinned
