...
| `support-matrix-schema.json` | `schemas/support-matrix-v1.json` at immutable beta.8 contract commit [`e074c7184451d53e0ba167f04776261813d986c9`](https://github.com/redact-secret/redact-secret-benchmarks/blob/e074c7184451d53e0ba167f04776261813d986c9/schemas/support-matrix-v1.json) | `scripts/check-benchmark-pins.py` check 5 (live): byte-identical to that pinned benchmark commit. | `npm run benchmark-pins:sync` |
