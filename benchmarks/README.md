...
| `support-matrix-schema.json` | `schemas/support-matrix-v1.json` at immutable beta.8 contract commit [`25e31c8319c441097f98db4e00b560395676f4a4`](https://github.com/redact-secret/redact-secret-benchmarks/blob/25e31c8319c441097f98db4e00b560395676f4a4/schemas/support-matrix-v1.json) | `scripts/check-benchmark-pins.py` check 5 (live): byte-identical to that pinned benchmark commit. | `npm run benchmark-pins:sync` |
