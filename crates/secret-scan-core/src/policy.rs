...
/// record (or, for `confluent_cloud_api_secret_legacy`,
/// `heroku_api_key_legacy`, and `mailchimp_api_key`, its own module doc in
/// `detectors::confluent`, `detectors::heroku`, or `detectors::mailchimp`)
/// explaining why a bare keyword-cooccurrence match at
