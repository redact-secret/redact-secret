...
- Command: `["target/release/examples/assessment_adapter","performance","--profile","scale-logs-medium-fixed4096","--runs","5","--json-out","assessment/results/release-profile/rust-core/scale-logs-medium-fixed4096.json","--markdown-out","assessment/results/release-profile/rust-core/scale-logs-medium-fixed4096.md"]`

## Timing and throughput distributions

| Measurement | Unit | Runs | Min | Median | p95 | Max | Mean | Population std dev |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Initialization | milliseconds | 5 | 0.009916 | 0.014375 | 0.093792 | 0.093792 | 0.030333200000000005 | 0.031880483932337035 |
| Steady-state processing | milliseconds | 5 | 114.969834 | 126.24454199999998 | 128.036583 | 128.036583 | 124.4933168 | 4.81579772168746 |
| Throughput | bytes-per-second | 5 | 2047492.9419195761 | 2076557.0997912926 | 2280198.1257100883 | 2280198.1257100883 | 2109107.2636506082 | 86340.89470026993 |
...
| processRss | 5 | 3211264 | 3735552 | available; Sampled immediately before and after processing; short-lived peaks between those boundaries may be missed, so maxima are observed samples, not guaranteed true peaks. |
