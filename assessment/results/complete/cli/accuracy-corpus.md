...
- Command: `node scripts/assessment-cli-run.mjs --binary target/release/redact-secret --json-out assessment/results/complete/cli/accuracy-corpus.json --markdown-out assessment/results/complete/cli/accuracy-corpus.md --mismatches-out assessment/results/complete/cli/accuracy-corpus-mismatches.json`
