...
- Command: `node scripts/assessment-python-run.mjs --python .venv/bin/python --json-out assessment/results/complete/python/accuracy-corpus.json --markdown-out assessment/results/complete/python/accuracy-corpus.md --mismatches-out assessment/results/complete/python/accuracy-corpus-mismatches.json`
