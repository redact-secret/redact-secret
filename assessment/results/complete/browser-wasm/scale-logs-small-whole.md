...
- Command: `node scripts/assessment-browser-performance.mjs --engine chromium --artifact-dir /Users/minhokang/orca/workspaces/redact-secret/automate-reproducible-evaluation-and-record-base/bindings/wasm/pkg --profile scale-logs-small-whole --runs 2 --json-out assessment/results/complete/browser-wasm/scale-logs-small-whole.json --markdown-out assessment/results/complete/browser-wasm/scale-logs-small-whole.md`

## Timing and throughput distributions

| Measurement | Unit | Runs | Min | Median | p95 | Max | Mean | Population std dev |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Initialization | milliseconds | 2 | 2.5 | 2.850000001490116 | 3.2000000029802322 | 3.2000000029802322 | 2.850000001490116 | 0.3500000014901161 |
| Steady-state processing | milliseconds | 2 | 6.799999997019768 | 7.299999997019768 | 7.799999997019768 | 7.799999997019768 | 7.299999997019768 | 0.5 |
| Throughput | bytes-per-second | 2 | 8404358.97757012 | 9022326.549721112 | 9640294.121872105 | 9640294.121872105 | 9022326.549721112 | 617967.5721509922 |
...
| browserJsHeap | 2 | 10000000 | 10000000 | available; Sampled immediately before and after processing; short-lived peaks between those boundaries may be missed, so maxima are observed samples, not guaranteed true peaks. performance.memory is non-standard, engine-dependent, and may be coarsened. |
