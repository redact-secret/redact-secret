...
- Command: `node scripts/assessment-run.mjs --json-out assessment/results/complete/node/accuracy-corpus.json --markdown-out assessment/results/complete/node/accuracy-corpus.md --mismatches-out assessment/results/complete/node/accuracy-corpus-mismatches.json`
