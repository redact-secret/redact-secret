...
- Command: `node scripts/assessment-browser-run.mjs --engine chromium --json-out assessment/results/beta.2/browser-chromium.json --markdown-out assessment/results/beta.2/browser-chromium.md --mismatches-out assessment/results/beta.2/browser-chromium-mismatches.json`
