...
- Host: darwin-25.5.0 / arm64 / webkit-26.6
- Command: `node scripts/assessment-browser-run.mjs --engine webkit --json-out assessment/results/beta.2/browser-webkit.json --markdown-out assessment/results/beta.2/browser-webkit.md --mismatches-out assessment/results/beta.2/browser-webkit-mismatches.json`
