...
- Command: `node scripts/assessment-cli-run.mjs --json-out assessment/results/cli/accuracy-corpus.json --markdown-out assessment/results/cli/accuracy-corpus.md --mismatches-out assessment/results/cli/accuracy-corpus-mismatches.json`
