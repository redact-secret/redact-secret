...
- Command: `node scripts/assessment-python-performance.mjs --python .venv/bin/python --profile scale-logs-small-whole --runs 5 --json-out assessment/results/acceptance/python/scale-logs-small-whole.json --markdown-out assessment/results/acceptance/python/scale-logs-small-whole.md`

## Timing and throughput distributions

| Measurement | Unit | Runs | Min | Median | p95 | Max | Mean | Population std dev |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Initialization | milliseconds | 5 | 0.896125 | 0.955542 | 1.003917 | 1.003917 | 0.9442501999999999 | 0.039006867771714256 |
| Steady-state processing | milliseconds | 5 | 10.521 | 10.682708 | 10.817958 | 10.817958 | 10.6533582 | 0.10906834427715485 |
| Throughput | bytes-per-second | 5 | 6059738.81577281 | 6136459.03267224 | 6230776.542153787 | 6230776.542153787 | 6154008.933577023 | 62912.54913814866 |
...
| processRss | 5 | 25853952 | 26443776 | available; Unix ru_maxrss high-water marks sampled immediately before and after a separate untimed processing pass; the value includes the Python interpreter, native extension, allocator, and earlier process activity and cannot isolate Rust-only memory. |
