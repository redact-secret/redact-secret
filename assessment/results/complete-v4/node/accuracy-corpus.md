...
- Command: `node scripts/assessment-run.mjs --json-out assessment-output-v4-real/node/accuracy-corpus.json --markdown-out assessment-output-v4-real/node/accuracy-corpus.md --mismatches-out assessment-output-v4-real/node/accuracy-corpus-mismatches.json`
